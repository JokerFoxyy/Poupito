...
> **Ordem de execução (atualizada 2026-07-25): #26 ✅ → #29 ✅ → #24 → (#27/#28/#30/#31 quando o usuário quiser) → #22 por último.** Os bugfix #26 (contas dessincronizadas) e #29 (recuperação de senha + endurecimento) já foram. A **próxima é a #24 (observabilidade/hardening)**. A **#22 (Open Finance) foi deliberadamente jogada pro fim** (decisão do usuário 2026-07-25): rodar todas as outras antes. A #24 continua vindo **antes** da #22 de propósito (a observabilidade suporta o job de sync do Open Finance). As #27/#28/#30/#31 encaixam quando o usuário quiser, mas **todas antes da #22**.
